...
Fair coin model probability = `r prob1`.

Biased coin model probability = `r prob2`.

The Bayes Factor = `r prob1/prob2`.
...
Tail-biased coin model probability = `r prob1`.

Head-biased model probability = `r prob2`.
